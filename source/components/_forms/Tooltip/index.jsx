...
// const ClonedChildren = (props) =>  React.cloneElement(props.ch, props);

const Tooltip = memo( ( { children, tooltip, hideArrow, className, intent, tooltipShown, onVisibilityChange, styleParent,...props } ) => {
    ...
    return <TooltipTrigger
        ...
        tooltip={({
            ...
            <StyledTooltip id="tooltip" onClick={()=>tooltipShown === undefined && setIsShow(false)} {...getTooltipProps({ref: tooltipRef})} intent={intent} hideArrow={hideArrow} enablePointerEvents={props && props.trigger === "click"}>
